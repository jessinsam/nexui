...
const ALL_COMPONENTS = [
  ...
  "card", "carousel", "chart", "checkbox", "cli", "code-block", "color-picker",
    ...
    <article className="max-w-3xl">
      ...
      <section className="mb-10">
        ...
        <p className="text-sm text-muted-foreground leading-relaxed mb-4">
          Run once per project. Creates <code className="text-xs font-mono text-foreground">lib/utils.ts</code> and injects the required CSS variables into <code className="text-xs font-mono text-foreground">globals.css</code>.
        </p>
      ...
      <section className="mb-10">
        ...
        <p className="text-sm text-muted-foreground leading-relaxed mb-4">
          These are all the component names you can pass to <code className="text-xs font-mono text-foreground">nexui add</code>. Each name maps exactly to a file in{" "}
          <code className="text-xs font-mono text-foreground">components/nexui/</code>.
        </p>
      ...
      <div className="rounded-lg border border-border bg-secondary/40 px-4 py-3 mb-10">
        <p className="text-xs text-muted-foreground leading-relaxed">
          ...
          Every component is available right now via copy-paste. Open the{" "}
          <Link href="/components" className="text-primary hover:underline">component library</Link>, click{" "}
          <strong className="text-foreground">Code</strong> on any card, and paste the source into your project at{" "}
